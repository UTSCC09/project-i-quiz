...
export default function NavBar({ additionalButtons }) {
  return (
    <header className="fixed h-24 sm:h-28 w-full bg-white shadow-sm flex items-center px-8 md:px-24 justify-between z-10 transition-all">
      <Link to="/">
...
function SettingsButton() {
  return (
    <div className="w-10 h-10 flex shrink-0 items-center justify-center rounded-full text-slate-500 hover:bg-gray-150 hover:text-slate-600 transition-all cursor-pointer">
      {/* [Credit]: svg from https://heroicons.dev */}

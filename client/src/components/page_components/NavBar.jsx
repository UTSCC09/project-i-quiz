...
function SettingsButton() {
  const [settingsDropdownShow, settingsDropdownShowSet] = useState(false);
  return (
    <div className="relative">
      <div
        className="w-10 h-10 flex shrink-0 items-center justify-center rounded-full text-slate-500 hover:bg-gray-150 hover:text-slate-600 transition-all cursor-pointer"
        onClick={() => {
          settingsDropdownShowSet(true);
        }}
      >
        {/* [Credit]: svg from https://heroicons.dev */}
        <svg
      ...
      <DropdownMenu
        ...
        dropdownShow={settingsDropdownShow}
        dropdownShowSet={settingsDropdownShowSet}
      />
    </div>
  );
}

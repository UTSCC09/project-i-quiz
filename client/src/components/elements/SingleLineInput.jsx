...
function VisibilityToggle({ id, isPasswordVisible, setIsPasswordVisible }) {
  return (
    <label
      htmlFor={id}
      className="absolute text-gray-400 hover:bg-gray-100 -translate-y-1/2 -translate-x-1/2 top-1/2 -end-2 h-[32px] w-[32px] flex items-center justify-center cursor-pointer rounded-md transition-all"
    >
      <input
        id={id}
        name={id}
